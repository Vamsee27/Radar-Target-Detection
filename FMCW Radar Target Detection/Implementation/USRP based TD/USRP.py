...
# Title: USRP Based Implementation
...
class USRP(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "USRP Based Implementation", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("USRP Based Implementation")
        ...
        self.blocks_delay_0_1 = blocks.delay(gr.sizeof_float*1, 1000)
        self.blocks_delay_0_0 = blocks.delay(gr.sizeof_float*1, 250)
        ...
        self.connect((self.blocks_complex_to_real_0_0, 0), (self.blocks_delay_0, 0))
        self.connect((self.blocks_complex_to_real_0_0, 0), (self.blocks_delay_0_0, 0))
        self.connect((self.blocks_complex_to_real_0_0, 0), (self.blocks_delay_0_1, 0))
        self.connect((self.blocks_delay_0, 0), (self.blocks_add_xx_0, 2))
        self.connect((self.blocks_delay_0_0, 0), (self.blocks_add_xx_0, 1))
        self.connect((self.blocks_delay_0_1, 0), (self.blocks_add_xx_0, 0))
        self.connect((self.blocks_head_0, 0), (self.blocks_file_sink_0, 0))
        self.connect((self.blocks_multiply_xx_0, 0), (self.low_pass_filter_0, 0))
        self.connect((self.blocks_multiply_xx_0, 0), (self.qtgui_freq_sink_x_0_1_0_0_0, 0))
        ...
        self.connect((self.low_pass_filter_0, 0), (self.blocks_skiphead_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, 750000, 50000, window.WIN_HAMMING, 6.76))
