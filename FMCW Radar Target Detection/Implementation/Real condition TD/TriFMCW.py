...
# Title: FMCW Real Time Condition
...
class TriFMCW(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "FMCW Real Time Condition", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("FMCW Real Time Condition")
        ...
        self.settings = Qt.QSettings("GNU Radio", "TriFMCW")
        ...
        self.qtgui_freq_sink_x_0_1_0_0_0.set_update_time(0.01)
        self.qtgui_freq_sink_x_0_1_0_0_0.set_y_axis((-140), 10)
        self.qtgui_freq_sink_x_0_1_0_0_0.set_y_label('Relative Gain', '')
        ...
        self.qtgui_freq_sink_x_0_1_0_0_0.set_fft_average(0.05)
        self.qtgui_freq_sink_x_0_1_0_0_0.enable_axis_labels(True)
        self.qtgui_freq_sink_x_0_1_0_0_0.enable_control_panel(False)
        self.qtgui_freq_sink_x_0_1_0_0_0.set_fft_window_normalized(True)
        ...
        self.qtgui_freq_sink_x_0_1 = qtgui.freq_sink_f(
            ...
            0, #fc
            samp_rate, #bw
            "Beat Signal(Frequency)", #name
            1,
            None # parent
        )
        self.qtgui_freq_sink_x_0_1.set_update_time(0.01)
        self.qtgui_freq_sink_x_0_1.set_y_axis((-140), 1)
        self.qtgui_freq_sink_x_0_1.set_y_label('Relative Gain', '')
        ...
        self.top_grid_layout.addWidget(self._qtgui_freq_sink_x_0_1_win, 0, 0, 2, 1)
        for r in range(0, 2):
        ...
        self.low_pass_filter_0 = filter.interp_fir_filter_fff(
            ...
            firdes.low_pass(
                ...
                window.WIN_HAMMING,
                6.76))
        self.blocks_vco_f_0_0 = blocks.vco_f(samp_rate, 9420000, 1)
        self.blocks_vco_f_0 = blocks.vco_f(samp_rate, 4710000, 1)
        self.blocks_skiphead_0 = blocks.skiphead(gr.sizeof_float*1, 0)
        self.blocks_multiply_xx_0_0_0 = blocks.multiply_vff(1)
        self.blocks_multiply_xx_0_0 = blocks.multiply_vff(1)
        self.blocks_multiply_xx_0 = blocks.multiply_vff(1)
        self.blocks_head_0 = blocks.head(gr.sizeof_float*1, 512000)
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_float*1, 'test_bin', False)
        self.blocks_file_sink_0.set_unbuffered(False)
        self.blocks_delay_0_1 = blocks.delay(gr.sizeof_float*1, 250)
        self.blocks_delay_0_0 = blocks.delay(gr.sizeof_float*1, 1000)
        ...
        self.connect((self.blocks_multiply_xx_0_0, 0), (self.qtgui_freq_sink_x_0_1_0_0_0, 0))
        ...
        self.connect((self.blocks_vco_f_0, 0), (self.blocks_multiply_xx_0_0_0, 0))
        ...
        self.connect((self.low_pass_filter_0_0, 0), (self.blocks_skiphead_0, 0))
        self.connect((self.low_pass_filter_0_0, 0), (self.qtgui_freq_sink_x_0_1, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, 2000000, 1000000, window.WIN_HAMMING, 6.76))
        self.low_pass_filter_0_0.set_taps(firdes.low_pass(1, self.samp_rate, 750000, 10000, window.WIN_HAMMING, 6.76))
...
def main(top_block_cls=TriFMCW, options=None):
