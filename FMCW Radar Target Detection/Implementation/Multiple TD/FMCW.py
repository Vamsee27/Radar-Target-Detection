...
class FMCW(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "FMCW Radar Test", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("FMCW Radar Test")
        ...
        self.blocks_skiphead_0_0 = blocks.skiphead(gr.sizeof_float*1, 524288)
        self.blocks_skiphead_0 = blocks.skiphead(gr.sizeof_gr_complex*1, 524288)
        self.blocks_multiply_conjugate_cc_0 = blocks.multiply_conjugate_cc(1)
        self.blocks_head_0_0 = blocks.head(gr.sizeof_float*1, 20000000)
        self.blocks_head_0 = blocks.head(gr.sizeof_gr_complex*1, 20000000)
        self.blocks_file_sink_0_0 = blocks.file_sink(gr.sizeof_float*1, 'test_saw.bin', False)
        self.blocks_file_sink_0_0.set_unbuffered(False)
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_gr_complex*1, 'test_mult.bin', False)
        self.blocks_file_sink_0.set_unbuffered(False)
        self.blocks_delay_0_1 = blocks.delay(gr.sizeof_gr_complex*1, 3000)
        self.blocks_delay_0_0 = blocks.delay(gr.sizeof_gr_complex*1, 1500)
        self.blocks_delay_0 = blocks.delay(gr.sizeof_gr_complex*1, 500)
        self.blocks_add_xx_0 = blocks.add_vcc(1)
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_TRI_WAVE, 2, 10, 0, 0)
